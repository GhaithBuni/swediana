...
// A sleek, responsive "Thank you for booking" page.
// Drop this into app/(marketing)/tack/page.tsx or similar.
// Pass booking data via query params like:
//   /tack?order=ABC123&service=Flyttstäd&date=2025-10-10&name=Anna&email=anna@example.com
// Or wire it to your store/fetcher as needed.

function formatDate(input?: string | null) {
  if (!input) return "–";
  const d = new Date(input);
  if (Number.isNaN(d.getTime())) return input; // if not ISO date, show raw
  ...
  return (
    <div className="min-h-screen w-full bg-background pt-16 ">
      <div className="max-w-5xl mx-auto px-6 ">
        ...
        {/* Subtle celebration confetti dots */}
        <motion.div
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
