...
export default function Page() {
  return (
    <main>
      ...
      <section className="relative overflow-hidden py-16 sm:py-20 md:py-28 px-4 sm:px-6 bg-white">
        <div className="mx-auto max-w-6xl">
          ...
          <div className="grid gap-8 md:grid-cols-2 lg:gap-10">
            <div className="group relative bg-gradient-to-br from-white to-gray-50 p-8 rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 border border-gray-100">
      ...
      <section className="relative overflow-hidden py-16 sm:py-20 md:py-28 px-4 sm:px-6 bg-gradient-to-b from-gray-50 to-white">
        {/* Decorative background */}
        <div className="absolute top-0 left-0 w-96 h-96 bg-[#95fff8] opacity-5 rounded-full blur-3xl"></div>
        <div className="absolute bottom-0 right-0 w-96 h-96 bg-[#6ee7df] opacity-5 rounded-full blur-3xl"></div>
        ...
        <div className="relative z-10 mx-auto max-w-6xl">
          ...
          <div className="mb-12">
            <div className="bg-white rounded-2xl shadow-xl p-8 border-t-4 border-[#95fff8]">
              <div className="flex items-center gap-4 mb-6">
                <div className="flex-shrink-0 w-16 h-16 bg-gradient-to-br from-[#95fff8] to-[#6ee7df] rounded-xl flex items-center justify-center shadow-lg">
                ...
                <div>
                  ...
                  <p className="text-gray-600">Initial rengöring</p>
                </div>
              </div>
              ...
              <ul className="space-y-3">
                <li className="flex items-start gap-3">
                  <svg
                    className="w-6 h-6 text-[#00bfa5] flex-shrink-0 mt-0.5"
                    fill="none"
                    stroke="currentColor"
                    viewBox="0 0 24 24"
                  >
          ...
          {/* Phase 2: Finstädning */}
          <div className="mb-12">
            <div className="bg-white rounded-2xl shadow-xl p-8 border-t-4 border-[#6ee7df]">
              <div className="flex items-center gap-4 mb-6">
                <div className="flex-shrink-0 w-16 h-16 bg-gradient-to-br from-[#6ee7df] to-[#95fff8] rounded-xl flex items-center justify-center shadow-lg">
                ...
                <div>
                  ...
                  <p className="text-gray-600">Detaljerad rengöring</p>
                </div>
              </div>
              <p className="text-gray-700 mb-6 leading-relaxed">
                ...
                <table className="w-full">
                  ...
                  <tbody className="divide-y divide-gray-200">
                    <tr className="hover:bg-gray-50 transition-colors">
                      <td className="px-6 py-4 font-semibold">Golv</td>
                    ...
                    <tr className="hover:bg-gray-50 transition-colors">
                      <td className="px-6 py-4 font-semibold">Fönster</td>
                      <td className="px-6 py-4 text-gray-700">
                    ...
                    <tr className="hover:bg-gray-50 transition-colors">
                      <td className="px-6 py-4 font-semibold">Ytor & Skåp</td>
                      <td className="px-6 py-4 text-gray-700">
                    ...
                    <tr className="hover:bg-gray-50 transition-colors">
                      <td className="px-6 py-4 font-semibold">Ventilation</td>
                      <td className="px-6 py-4 text-gray-700">
      ...
      {/* CTA Section */}
      <section className="relative overflow-hidden py-16 sm:py-20 md:py-24 px-4 sm:px-6 bg-gradient-to-br from-[#95fff8] via-[#6ee7df] to-[#4dd5c4]">
        ...
        <div className="relative z-10 mx-auto max-w-4xl text-center">
          ...
          <p className="text-xl sm:text-2xl text-white mb-4 drop-shadow-md">
            Vi vet att varje byggprojekt är unikt.
          </p>

          <p className="text-lg sm:text-xl text-white text-opacity-95 mb-10 max-w-2xl mx-auto leading-relaxed drop-shadow-md">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            <a
              href="/byggstad"
              className="inline-flex items-center gap-2 bg-white text-[#00bfa5] px-8 py-4 rounded-xl font-bold text-lg shadow-xl hover:shadow-2xl hover:scale-105 transition-all duration-300"
            >
              <svg
                className="w-6 h-6"
                fill="none"
            ...
            <a
              ...
              className="inline-flex items-center gap-2 bg-white bg-opacity-20 backdrop-blur-sm text-[#00bfa5] border-2 border-white px-8 py-4 rounded-xl font-bold text-lg shadow-xl hover:bg-white hover:text-[#00bfa5] hover:scale-105 transition-all duration-300"
            >
              <svg
                className="w-6 h-6"
                fill="none"
          ...
          <p className="mt-8 text-white text-opacity-90 text-sm sm:text-base">
